// uczlwj0 - Code Source: the code is adapted from Claire's Web GIS practical week 5,6,and 7 
...
//Question Setting APP - upload quiz
...
// uczlwj0 - make sure the table name and the column name are the same in the database - the database is case sensitive
var querystring = "INSERT into webgisquestion (question_id,question,answer_1,answer_2, answer_3, answer_4, correct_answer, location_name, geom) values ('"; querystring = querystring + req.body.question_id + "','" + req.body.question + "','" + req.body.answer_1 + "','"; querystring = querystring + req.body.answer_2 + "','" + req.body.answer_3 + "','" + req.body.answer_4+"','" + req.body.correct_answer + "','" + req.body.location_name + "',"+geometrystring + "))";
...
//Location Based Quiz APP - upload user's answer
...
// uczlwj0 - make sure the table name and the column name are the same in the database - the database is case sensitive
var querystring = "INSERT into webgisanswer (question_id,user_answer,correct_answer) values ('"; querystring = querystring + req.body.question_id + "','" + req.body.user_answer + "','" + req.body.correct_answer + "'))";
console.log(querystring);
client.query( querystring,function(err,result) {
done();
if(err){
